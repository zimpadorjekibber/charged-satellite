        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              <a href="https://www.instagram.com/explore/locations/275332192321798/tashi-zom-restaurant-kibber/" target="_blank" className="p-3 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] rounded-full text-white hover:scale-110 transition-all shadow-xl border border-white/20">
