        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-6">
              ...
              <a href="https://facebook.com/tashizom" target="_blank" className="p-3 bg-[#1877F2] rounded-full text-white hover:scale-110 transition-all shadow-xl border border-white/20">
